package zhangman523.github.snakeio.screens.transitions;
...
public class ScreenTransitionSlice implements ScreenTransition {
    ...
    public static ScreenTransitionSlice init(float duration, int direction, int numSlices, Interpolation easing) {
        ...
        //create shuffled list pf slice indices which determines the order of slice animation
    ...
    public void render(SpriteBatch batch, Texture currScreen, Texture nextScreen, float alpha) {
        ...
        batch.begin();
        batch.draw(currScreen, 0, 0, 0, 0, w, h,
                1, 1, 0, 0, 0,
